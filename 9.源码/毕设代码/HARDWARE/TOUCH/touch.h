...
//与触摸屏芯片连接引脚	   
//与触摸屏芯片连接引脚	   
#define PEN  PAin(11)    //PC10  INT
#define DOUT PAin(12)     //PC2  MISO		 PC2--PB14
#define TDIN PAout(1)    //PC3  MOSI		 PC3--PB15
#define TCLK PAout(2)    //PC0  SCLK	 PC0--PB13
#define TCS  PAout(3)   //PC13 CS    
